...
Public Class User
    ...
    Public Class User
        ...
        Public Class User
            ...
            ' Constructor
            Public Sub New(username As String, password As String, email As String, phoneNumber As String, registerDate As Date)
                _username = username
                _password = password
                _email = email
            ...
            ' Save email and password to a text file (database not yet ready)
            ...
            Public Sub UpdateAcc(Optional email As String = Nothing, Optional phoneNumber As String = Nothing)
